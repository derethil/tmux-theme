<h3 align="center">
	<img src="https://github.com/rebelot/kanagawa.nvim/blob/master/kanagawa@2x.png?raw=true" width="100" alt="Logo"/><br/>
	<img src="https://github.com/rebelot/kanagawa.nvim/blob/master/kanagawa@2x.png?raw=true" height="30" width="0px"/>
	Kanagawa for <a href="https://github.com/tmux/tmux">Tmux</a>
	<img src="https://github.com/rebelot/kanagawa.nvim/blob/master/kanagawa@2x.png?raw=true" height="30" width="0px"/>
</h3>

<p align="center">
    <a href="https://github.com/derethil/kanagawa-tmux/stargazers"><img src="https://img.shields.io/github/stars/derethil/kanagawa-tmux?colorA=1F1F28&colorB=658594&style=for-the-badge"></a>
    <a href="https://github.com/derethil/kanagawa-tmux/issues"><img src="https://img.shields.io/github/issues/derethil/kanagawa-tmux?colorA=1F1F28&colorB=957FB8&style=for-the-badge"></a>
    <a href="https://github.com/derethil/kanagawa-tmux/contributors"><img src="https://img.shields.io/github/contributors/derethil/kanagawa-tmux?colorA=1F1F28&colorB=98BB6C&style=for-the-badge"></a>
</p>
...
- 🌻 [Wave](./themes/catppuccin_wave.tmuxtheme)
- 🪴 [Dragon](./themes/catppuccin_dragon.tmuxtheme)
- 🌺 [Lotus](./themes/catppuccin_lotus.tmuxtheme)

## Installation

In order to have the icons displayed correctly please use/update your favorite
[patched font](https://www.nerdfonts.com/font-downloads). If you do not have a
patched font installed, you can override or remove any icon. Check the
documentation below on the options available.

### TPM

1. Install [TPM](https://github.com/tmux-plugins/tpm)
2. Add the Kanagawa plugin:
...
```bash
set -g @kanagawa_flavour 'wave' # latte,frappe, macchiato or mocha
```
...
4. Reload Tmux by either restarting the session or reloading it with
   `tmux source-file ~/.tmux.conf`

## Overview

![Default](./assets/overview.png) This is a diagram of how the theme is split
between its components.

## Configuration options

All flavors support certain levels of customization that match our
[Kanagawa Style Guide][style-guide]. To add these customizations, add any of the
...
```sh
set -g @kanagawa_window_separator ""
```
...
```sh
set -g @kanagawa_window_status_enable "no"
```
...
```sh
set -g @kanagawa_window_status_icon_enable "yes"
```
...
```sh
set -g @kanagawa_icon_window_last "󰖰"
set -g @kanagawa_icon_window_current "󰖯"
set -g @kanagawa_icon_window_zoom "󰁌"
set -g @kanagawa_icon_window_mark "󰃀"
set -g @kanagawa_icon_window_silent "󰂛"
set -g @kanagawa_icon_window_activity "󱅫"
set -g @kanagawa_icon_window_bell "󰂞"
```
...
```sh
set -g @kanagawa_window_default_fill "number"
```
...
```sh
set -g @kanagawa_window_default_color "#{thm_blue}" # text color
set -g @kanagawa_window_default_background "#{thm_gray}"
```
...
```sh
set -g @kanagawa_window_default_text "#{b:pane_current_path}" # use "#W" for application instead of directory
```
...
```sh
set -g @kanagawa_window_current_fill "number"
```
...
```sh
set -g @kanagawa_window_current_color "#{thm_orange}" # text color
set -g @kanagawa_window_current_background "#{thm_bg}"
```
...
```sh
set -g @kanagawa_window_current_text "#{b:pane_current_path}" # use "#W" for application instead of directory
```
...
```sh
set -g @kanagawa_pane_border_style "fg=#{thm_gray}" # Use a value compatible with the standard tmux 'pane-border-style'
```

#### Set the pane active border style:

```sh
set -g @kanagawa_pane_active_border_style "fg=#{thm_orange}" # Use a value compatible with the standard tmux 'pane-border-active-style'
```
...
```sh
set -g @kanagawa_status_default "on"
```

#### Override the default status background color

```sh
set -g @kanagawa_status_background "theme"
```
...
```sh
set -g @kanagawa_status_connect_separator "yes"
```
...
```sh
set -g @kanagawa_status_justify "left"
```
...
```sh
set -g @kanagawa_pane_status_enabled "no"
set -g @kanagawa_pane_border_status "off" # See `pane-border-status`
set -g @kanagawa_pane_left_separator "█"
set -g @kanagawa_pane_right_separator "█"
set -g @kanagawa_pane_middle_separator "█"
set -g @kanagawa_pane_number_position "left"
set -g @kanagawa_pane_default_fill "number"
set -g @kanagawa_pane_default_text "#{b:pane_current_path}"
set -g @kanagawa_pane_border_style "fg=#{thm_orange}"
set -g @kanagawa_pane_active_border_style "fg=#{thm_orange}"
set -g @kanagawa_pane_color "#{thm_orange}"
set -g @kanagawa_pane_background_color "#{thm_orange}"
```

#### Set the module list

```sh
set -g @kanagawa_status_modules_right "application session"
set -g @kanagawa_status_modules_left ""
```
...
Load tmux-battery after you load kanagawa.
...
```sh
set -g @kanagawa_status_modules_right "... battery ..."
```
...
Load tmux-cpu after you load kanagawa.
...
```sh
set -g @kanagawa_status_modules_right "... cpu ..."
```
...
Load tmux-weather after you load kanagawa.
...
```sh
set -g @kanagawa_status_modules_right "... weather ..."
```
...
Load tmux-clima after you load kanagawa.
...
```sh
set -g @kanagawa_status_modules_right "... clima ..."
```
...
Load tmux-loadavg after you load kanagawa.
...
```sh
set -g @kanagawa_status_modules_right "... load ..."
```
...
```sh
set -g @kanagawa_status_modules_right "... gitmux ..."
```
...
```sh
set -g @kanagawa_gitmux_text "#(gitmux -cfg $HOME/.gitmux.conf \"#{pane_current_path}\")"
```
...
Any file added to the custom folder will be preserved when updating kanagawa.
...
set -g @kanagawa_status_modules_right "application session user host date_time"
set -g @kanagawa_status_left_separator "█"
set -g @kanagawa_status_right_separator "█"
...
set -g @kanagawa_window_current_fill "number"
set -g @kanagawa_window_current_text "#{pane_current_path}"

set -g @kanagawa_status_modules_right "application session date_time"
set -g @kanagawa_status_left_separator  ""
set -g @kanagawa_status_right_separator " "
...
set -g @kanagawa_status_modules_right "directory user host session"
set -g @kanagawa_status_left_separator  " "
set -g @kanagawa_status_right_separator ""
set -g @kanagawa_status_fill "icon"
set -g @kanagawa_status_connect_separator "no"

set -g @kanagawa_directory_text "#{pane_current_path}"
```
...
<p align="center"><a href="https://github.com/catppuccin/catppuccin/blob/main/LICENSE"><img src="https://img.shields.io/static/v1.svg?style=for-the-badge&label=License&message=MIT&logoColor=1F1F28&colorA=1F1F28&colorB=363a4f"/></a></p>
